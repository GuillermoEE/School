...
class SpecialitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post specialities_url, params: { speciality: { eveningClasses: @speciality.eveningClasses, eveningTurn: @speciality.eveningTurn, morningClasses: @speciality.morningClasses, morningTurn: @speciality.morningTurn, name: @speciality.name, numberStudents: @speciality.numberStudents } }
    end
  ...
  test "should update speciality" do
    patch speciality_url(@speciality), params: { speciality: { eveningClasses: @speciality.eveningClasses, eveningTurn: @speciality.eveningTurn, morningClasses: @speciality.morningClasses, morningTurn: @speciality.morningTurn, name: @speciality.name, numberStudents: @speciality.numberStudents } }
