class Request < ApplicationRecord
  ...
  validates :examMark, :schoolAverage, :numericality => { :greater_than_or_equal_to => 6, :less_than_or_equal_to => 10, message: "Ingresa un numero que sea mayor 6 o un numero menor o igual a 10" }
